...
# 12 "ECU/KEYPAD/../../HAL/GPIO/hal_gpio.h"
...
# 15 "ECU/KEYPAD/../../HAL/GPIO/../std_libraries.h" 2
...
Std_ReturnType keypad_initialize(const keypad_t* obj)
{
    ...
    {
        uint8 num_row = 0, num_col = 0;

        for(num_row = 0; num_row<4; num_row++)
        {
            ret = gpio_pin_initialize(&(obj->keypad_row_pins[num_row]));
        }

        for(num_col = 0; num_col<4; num_col++)
        {
