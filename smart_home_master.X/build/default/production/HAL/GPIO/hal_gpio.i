...
# 1 "HAL/GPIO/hal_gpio.h" 1
# 12 "HAL/GPIO/hal_gpio.h"
...
# 12 "HAL/GPIO/hal_gpio.h" 2


# 1 "HAL/GPIO/../mcal_std_types.h" 1
# 18 "HAL/GPIO/../mcal_std_types.h"
# 1 "HAL/GPIO/../compiler.h" 1
# 15 "HAL/GPIO/../compiler.h"
...
# 15 "HAL/GPIO/../compiler.h" 2
# 18 "HAL/GPIO/../mcal_std_types.h" 2

# 1 "HAL/GPIO/../std_libraries.h" 1
# 15 "HAL/GPIO/../std_libraries.h"
...
# 19 "HAL/GPIO/../std_libraries.h" 2
# 19 "HAL/GPIO/../mcal_std_types.h" 2
# 54 "HAL/GPIO/../mcal_std_types.h"
...
# 14 "HAL/GPIO/hal_gpio.h" 2


# 1 "HAL/GPIO/../device_config.h" 1
# 16 "HAL/GPIO/hal_gpio.h" 2


# 1 "HAL/GPIO/hal_gpio_cfg.h" 1
# 18 "HAL/GPIO/hal_gpio.h" 2
# 48 "HAL/GPIO/hal_gpio.h"
typedef enum
{
    GPIO_LOW=0,
    GPIO_HIGH
...
# 41 "HAL/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t* pin_config)
{
    Std_ReturnType Ret = (Std_ReturnType)0X01;

    if( (((void*)0) == pin_config) || (pin_config->Pin >= 8) || (pin_config->Port >= 5))
    {
...
# 89 "HAL/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t* pin_config, direction_t* direction_status)
{

    Std_ReturnType Ret = (Std_ReturnType)0X01;

    if((((void*)0) == pin_config) || (((void*)0) == direction_status) || (pin_config->Pin >= 8) || (pin_config->Port >= 5))
    {
        Ret = (Std_ReturnType)0X00;
    }
    else
...
# 162 "HAL/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_read_logic(const pin_config_t* pin_config, logic_t* logic)
{
    Std_ReturnType Ret = (Std_ReturnType)0X01;

    if((((void*)0) == pin_config) || (((void*)0) == logic) || (pin_config->Pin >= 8) || (pin_config->Port >= 5))
    {
        Ret = (Std_ReturnType)0X00;
    }
